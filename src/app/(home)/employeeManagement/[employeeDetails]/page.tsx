...
const EmployeeDetails = ({ params }: { params: { employeeDetails: string } }) => {
    console.log(params);
    const [selectedItem, setSelectedItem] = useState<React.ReactNode>('All requested Document');
    ...
    const BankDetails = () => {
        return (
            <div className="flex flex-col gap-y-6 w-full">
                ...
                />
                <TextGroup textgroupStyle="flex flex-col gap-y-1" title={'Institution number'} subTitle={'3647838'} />
                <TextGroup textgroupStyle="flex flex-col gap-y-1" title={'Branch code'} subTitle={'3647838'} />
                <DocumentCard
            ...
            <div className="flex gap-x-10 w-full h-[-webkit-fill-available] mt-2">
                <div className="flex flex-col w-[36.4%]">
                    ...
                    <div className="inline-flex border border-borderGrey rounded-lg p-3 gap-x-[69px] text-[16px] leading-[20px] mt-6">
                        <TextGroup textgroupStyle="flex flex-col gap-y-1" title="Date" subTitle="04/08/2000" />
                        <TextGroup textgroupStyle="flex flex-col gap-y-1" title="Gender" subTitle="Female" />
                        <TextGroup
                            textgroupStyle="flex flex-col gap-y-1"
                            title="Work status"
